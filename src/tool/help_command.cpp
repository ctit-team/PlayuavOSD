...
std::string help_command::description() const
{
...
std::string help_command::help_text() const
{
...
{
	auto &commands = program::instance.commands();
...
void help_command::print_commands()
{
	...
	for (auto &e : program::instance.commands()) {
